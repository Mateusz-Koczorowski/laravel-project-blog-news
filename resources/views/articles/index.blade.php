<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @else
                <!-- No Articles Message -->
                <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-md sm:rounded-lg p-6 text-center">
                    <h3 class="font-bold text-2xl text-gray-800 dark:text-gray-100 mb-4">
                        No Articles Available
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        It seems there are no articles at the moment. Please check back later!
                    </p>
                </div>
            @endif
        </div>
